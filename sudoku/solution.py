...
def naked_twins(values):
    ...
    # Find all instances of naked twins and group by units
...
diag_units_rev = [[rev_rows[i]+cols[i] for i in range(len(rows))]]
unitlist = row_units + column_units + square_units + diag_units + diag_units_rev
